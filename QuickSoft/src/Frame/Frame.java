		...
		btn.setOnAction((ActionEvent e) -> {
			...
			btn4.setOnAction(new EventHandler<ActionEvent>() {
				...
				public void handle(ActionEvent e) {
					...
					String output = "";
					if (rb1.isSelected()) {
						output = Init.creatRandomText(Integer.parseInt(tf.getText()), "随机用例");
					} else if (rb2.isSelected()) {
						output = Init.creatAscendText(Integer.parseInt(tf.getText()), "升序用例");
					} else if (rb3.isSelected()) {
						output = Init.creatDescendText(Integer.parseInt(tf.getText()), "降序用例");
					} else if(rb4.isSelected()){
						output = Init.creatRepeatText(Integer.parseInt(tf.getText()), "重复用例");
					}
